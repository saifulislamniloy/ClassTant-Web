              ...
              <Row>
                  <Col sm={12} md={12} lg={12}>
                      ...
                      <p className="pb-5 pl-5 pr-5 text-justify">
                          ...
                          You can manage everything related to your academic stuff. Currently we all use some social platform to handle academy related stuff. And we all know that this is not healthy for us. Some of us get addicted to social media and also it create social dilemma.
                          So, we decided to being a good alternative of social media to you to prevent this social dilemma.
                      </p>
                  </Col>
                  ...
                  <Col sm={12} md={12} lg={12}   className="text-center">
                      ...
                      <a href="https://play.google.com/store/apps/details?id=com.classtant.android" target="#"> <Image src={banner} height="75"/></a>
                  </Col>
              </Row>
              <Row>
                  <Col sm={6} md={6} lg={6}>
                  ...
                  <Col sm={6} md={6} lg={6}>
                      ...
                      <p className="pb-5 pl-5 pr-5 text-justify">
                          This is Incomplete till now. For urgent demand, we are providing some feature for teachers only.
                      </p>
                  </Col>
              </Row>
